...
from .utils import get_angular_file_names
...
SECRET_KEY = "django-insecure-3u0^ia49jq=mwk12eid#u86$2^^2n0%gqyu01g9o-w20ac4#*-"
...
CSRF_TRUSTED_ORIGINS = ["https://rabbit.guisilva.com"]
...
DUMMY_DATABASE = os.getenv("DUMMY_DATABASE", "false").lower() == "true"
